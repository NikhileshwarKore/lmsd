...
const OPENGRAPH_API_KEY = 'a8420145-4a71-4804-a2be-42a69205b39e	';
...
export default class ChatMessageDefaultUI extends BaseChatMessage {
    ...
    connectedCallback() {
        ...
        if (this.isPlainText) {
            ...
            const requestURL = 'https://opengraph.io/api/1.1/site/' + urlEncoded + '?app_id=' + 'a8420145-4a71-4804-a2be-42a69205b39e';
